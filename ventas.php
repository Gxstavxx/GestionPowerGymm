...
$conn = new mysqli(
    'b8mdzmrdi0ebsdgsmhql-mysql.services.clever-cloud.com', // Host
    'umgounumngu5bdpl', // Usuario
    'Vb5l4IcA9KzmM8OIbVsG', // Contraseña
    'b8mdzmrdi0ebsdgsmhql' // Base de datos
);
...
<body>
    <div class="container mt-5">
        ...
        <!-- Icono de casita -->
        <a href="index.html" class="btn btn-secondary mb-3" title="Inicio">
